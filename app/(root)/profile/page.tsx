  ...
  return (
    ...
    <div className= "bg-[#fff] px-2 py-4 rounded-b-xl">
      <div className="grid grid-cols-3 text-center h-24 items-center">
        <div><h1>Chris Kevin</h1></div>
        <div><h1>Chriskevin26@gmail.com</h1></div>
        <div><h1>chr*************</h1></div>
      </div>
    </div>
    </div>
...
<button className='bg-black text-white px-16 py-2 rounded-xl'>Logout</button>
</div>
    </div>
    </div>
    </div>
